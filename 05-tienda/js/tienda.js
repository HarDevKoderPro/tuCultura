 ...
 * ✅ Universal: Detecta la ruta automáticamente
 */

// ✅ API_BASE dinámica — funciona en cualquier carpeta sin cambios
const pathArray = window.location.pathname.split("/");
pathArray.pop(); // Quita el archivo actual (index.html, carrito.html, etc.)
const API_BASE = pathArray.join("/") + "/php/";
console.log("API detectada en:", API_BASE);
